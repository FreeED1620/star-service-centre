      ...
      <section className="bg-automotive-dark text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <AnimatedText as="h1" className="text-4xl md:text-5xl font-bold mb-6">
              About BikeService Pro Workshop
            </AnimatedText>
            <AnimatedText as="p" className="text-xl text-gray-300 leading-relaxed" delay={0.1}>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map((stat, index) => (
              <AnimatedText key={index} as="div" className="text-center" delay={index * 0.1}>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <AnimatedText as="h2" className="text-3xl font-bold text-foreground mb-6">Our Story</AnimatedText>
      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <Card className="p-8">
              <AnimatedText as="h3" className="text-2xl font-bold text-foreground mb-4">Our Mission</AnimatedText>
            ...
            <Card className="p-8">
              <AnimatedText as="h3" className="text-2xl font-bold text-foreground mb-4">Our Vision</AnimatedText>
              <AnimatedText as="p" className="text-muted-foreground" delay={0.1}>
          ...
          <div>
            <AnimatedText as="h2" className="text-3xl font-bold text-center text-foreground mb-12">
              Our Core Values
            </AnimatedText>
            <div className="grid md:grid-cols-4 gap-6">
              {values.map((value, index) => (
                <Card key={index} className="p-6 text-center">
                  <AnimatedText as="h3" className="text-lg font-semibold text-foreground mb-2" delay={index * 0.1}>
                    {value.title}
                  </AnimatedText>
                  <AnimatedText as="p" className="text-sm text-muted-foreground" delay={index * 0.1 + 0.1}>
                    {value.description}
                  </AnimatedText>
                </Card>
              ))}
